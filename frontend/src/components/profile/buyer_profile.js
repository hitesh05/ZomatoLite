...
import Display from './buyer_display'
import Edit from './buyer_edit'
...
const Profile = (props) => {
    ...
    console.log(localStorage.getItem('ZomatoRole'));
    ...
    const handleEdit = async () => {
        try {
            const res = await axios.post('http://localhost:4000/buyer/update', user);
